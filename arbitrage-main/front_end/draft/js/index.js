...
function createRow(data) {
  ...
  <tr>
      ...
      <td class="pair-cell">
          🟢 <img src="gate.svg" alt="">
          <a href="${links[data['max']['exchange']].replace(/#/, data['coin'])}" class="exchange_link"><img src="icon/${data['max']['exchange']}.png" width="20px" height="20px"> ${data['max']['exchange']}</a>
  ...
  <tr class="second_tr">
      ...
      <td class="pair-cell">
          🔴 <img src="mexc.svg" alt="">
          <a href="${links[data['min']['exchange']].replace(/#/, data['coin'])}" class="exchange_link"><img src="icon/${data['min']['exchange']}.png" width="20px" height="20px"> ${data['min']['exchange']}</a>
